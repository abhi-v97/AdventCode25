...
int main()
{
  ...
  // modification from part1:
  // calc_neighbour swaps removed papers with '.'
  // keep repeating the loop until no more papers are removed, i.e temp = 0
  do
  {
	temp = 0;
	for (int x = 0; x < 140; x++)
